#!/bin/bash
nsrc=$(ls -lah ../../../eos_inference/narrow_ETT/gw_posteriors | grep "source" | wc -l)
...
posterior_file: ../../../eos_inference/narrow_ETT/gw_posteriors/source_${src}/posterior_mm.npz
