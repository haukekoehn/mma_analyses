#!/bin/bash
nsrc=$(ls -lah ../../../eos_inference/wide_ETL/gw_posteriors | grep "source" | wc -l)
...
posterior_file: ../../../eos_inference/wide_ETL/gw_posteriors/source_${src}/posterior_mm.npz
