...
from jesterTOV.inference.likelihoods import CosmoMMSelectionLikelihood, CombinedLikelihood, ConstraintEOSLikelihood, RadioTimingLikelihood
...
for src in range(events.shape[0]):
    ...
    likelihood = CosmoMMSelectionLikelihood(
