...
for src in range(events.shape[0]):
    ...
    likelihood = MultiMessengerLikelihood(
        ...
        posterior_gw = f"../gw_posteriors/source_{src}/posterior.npz",
        conditional_flow_gw = f"../gw_nfs/source_{src}/cnf_gw_nodist",
        mass_model_logpdf=recycledbinary_logpdf,
        flow_em = None,
        use_em=False,
        cflow_gw_distance=False,
