...
#SBATCH -J narrow_ETL_nf_mm_${src}
#SBATCH -o ./source_${src}/nfs_mm/log_nf
#SBATCH -e ./source_${src}/nfs_mm/log_nf
...
posterior_file: ./source_${src}/posterior_mm.npz
output_dir: ./source_${src}/nfs_mm/nf
...
cat <<CONFIG_EOF > nf_mm_config_${src}.yaml

posterior_file: ./source_${src}/posterior_mm.npz
output_dir: ./source_${src}/nfs_mm/nf_cond

# Parameter selection
parameter_names: ["mass_1_source", "mass_2_source", "luminosity_distance", "cos_theta_jn"]
...
train_jester_flow "./nf_mm_config_${src}.yaml"
rm ./nf_mm_config_${src}.yaml
SBATCH_EOF
