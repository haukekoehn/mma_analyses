...
#SBATCH -J narrow_ETL_cond_nf_mm_${src}
#SBATCH -o ./source_${src}/nfs_mm/log_cnf
#SBATCH -e ./source_${src}/nfs_mm/log_cnf
...
output_dir: ./source_${src}/nfs_mm/cnf
...
cond_dim: 4
cond_parameter_names: ["mass_1", "mass_2", "luminosity_distance", "cos_theta_jn"]
CONFIG_EOF
