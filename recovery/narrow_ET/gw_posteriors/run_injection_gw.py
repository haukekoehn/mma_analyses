...
def main():
    ...
    injection_parameters = events.loc[int(args.source), ["mass_1", "mass_2", "chi_1", "chi_2", "lambda_1", "lambda_2", "theta_jn", "luminosity_distance", "phase", "psi", "ra", "dec", "geocent_time"]].to_dict()
    
       
    CHIEFF = (injection_parameters['chi_1'] * injection_parameters['mass_1'] + injection_parameters['chi_2'] * injection_parameters['mass_2']) / (injection_parameters['mass_1'] + injection_parameters['mass_2'])
