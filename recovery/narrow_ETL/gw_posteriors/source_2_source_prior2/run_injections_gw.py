...
def main():
    ...
    del priors["mass_1"]
    del priors["mass_2"]
    priors["mass_1_source"] = bilby.core.prior.Uniform(minimum=1, maximum=2, latex_label=r'$m_1^s$')
    priors["mass_2_source"] = bilby.core.prior.Uniform(minimum=1, maximum=2, latex_label=r'$m_2^s$')

    #priors['chirp_mass'] = bilby.gw.prior.Uniform(name='chirp_mass', minimum=MCHIRP-0.01, maximum=MCHIRP+0.01)
    ...
    likelihood = GravitationalWaveTransientLikelihood(
        ...
        reference_chirp_mass=1**0.6/2**0.2,
